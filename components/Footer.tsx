...
export default function Footer() {
  return (
    <footer id="contact" className="relative scroll-mt-16 bg-background border-t border-white/[0.06] overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 lg:px-10 py-14 grid gap-10 md:grid-cols-3">
        ...
        <Reveal delay={0.2}>
          ...
          <ul className="text-sm text-white/60 space-y-2">
            <li>Прилеп: <a className="text-white hover:text-brand-2" href="tel:+38970353619">+389 70 353 619</a></li>
            <li>Скопје: <a className="text-white hover:text-brand-2" href="tel:+38970266179">+389 70 266 179</a></li>
      ...
      <div className="relative border-t border-white/[0.06] py-4 text-center text-xs text-white/35">
        ...
        <Link href="/privacy" className="hover:text-white">Политика за приватност</Link> ·{" "}
        <Link href="/terms" className="hover:text-white">Услови за користење</Link>
      </div>
    </footer>
  );
}
